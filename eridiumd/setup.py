...
setup(
    name='eridiumd',
    version=find_version('lib/eridiumd/__init__.py'),
    package_dir={'': 'lib'},
    packages=find_packages('lib'),
    scripts=['bin/eridiumd'],
    ...
    description=(
        'Eridium is a packet generator RESTfull API, a Python client, and a '
        'server reference implementation.'
    ),
    long_description=read('README.rst'),
    url='https://github.com/HPENetworking/eridium',
    keywords='eridiumd',
